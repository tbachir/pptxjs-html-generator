...
export function getVerticalAlign(node: any, slideLayoutSpNode?: any, slideMasterSpNode?: any, type?: string): string {
...
export function getContentDir(node: any, type: string, warpObj: any): string {
