export function getPosition(slideXfrmNode, pNode, slideLayoutXfrmNode, slideMasterXfrmNode, sType) {
    let x = 0, y = 0;
...
export function getSize(slideXfrmNode, slideLayoutXfrmNode, slideMasterXfrmNode) {
